import { OWNER_DISPLAY_NAME } from "./identity.mjs";

// Real, sourced content for Mukhtada.
...
export const profile = {
  ...
  lede_id:
    "I'm Mukhtada, an Information Systems student at the University of Jambi. I build full-stack web products, AI tools, data projects, and published research.",
  about:
    "I am Mukhtada, an Information Systems student at the University of Jambi. I build full-stack web products and AI tools, work with data, and publish information systems research. My experience includes backend development, web platform maintenance, student mentoring, and community technology projects.",
  links: {
...
export const publicPageCopy = {
  home: {
    metadataTitle: "Mukhtada — Full-Stack Developer, AI & Data",
    metadataDescription:
      "Mukhtada is an Information Systems student at the University of Jambi who builds full-stack web products, AI tools, data projects, and research.",
    keywords: [
      "Mukhtada",
  ...
  about: {
    metadataTitle: "About Mukhtada",
    metadataDescription:
      "Mukhtada studies Information Systems at the University of Jambi and works on full-stack web development, AI tools, data science, and research.",
    keywords: [
      "Mukhtada",
  ...
  projects: {
    ...
    metadataDescription:
      "Web, AI, data science, and research projects by Mukhtada, with project summaries, technology stacks, and source links.",
    keywords: [
      "Mukhtada projects",
  ...
  research: {
    ...
    metadataDescription:
      "Published information systems research by Mukhtada on education analytics, scheduling optimization, tourism digitization, and safety systems.",
    keywords: [
      "Mukhtada research",
  ...
  blog: {
    ...
    metadataDescription:
      "Articles by Mukhtada about Next.js, AI tooling, open-source software, technical investigations, and information systems research.",
    keywords: [
      "Mukhtada blog",
      "Next.js articles",
      "AI tooling",
  ...
  contact: {
    metadataTitle: "Contact Mukhtada",
    metadataDescription:
      "Contact Mukhtada about full-stack web development, AI tooling, data projects, research, or community technology work.",
    keywords: [
      "contact Mukhtada",
      "full-stack developer Jambi",
