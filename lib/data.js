...
export const blogPosts = [
  {
    ...
    title: "Catatan Riset KNN Pendidikan",
    excerpt: "Rancangan lore entry tentang proses publikasi prediktif tren pendidikan, dari data mentah sampai model KNN.",
    ...
    blocks: [
      { type: "heading", text: "Latar belakang riset" },
      { type: "paragraph", text: "Entry ini disiapkan untuk CMS blog. Kontennya akan mengambil konteks dari publikasi KNN yang sudah tercatat di halaman Research." },
      { type: "quote", text: "Tujuan CMS: menulis proses kerja, bukan membuat metrik baru." },
    ],
  },
  {
    id: "blog-tnks-devlog",
    ...
    excerpt: "Draft dev log tentang sistem e-ticketing TNKS, alur reservasi, dan kontribusi front-end/back-end.",
    status: "local-preview",
    tags: ["Web", "Research"],
    publishedAt: "CMS pending",
    readTime: "6 min baca",
    ...
    blocks: [
      { type: "heading", text: "Masalah yang diselesaikan" },
      { type: "paragraph", text: "Reservasi online menggantikan pemesanan on-site. Entry ini disiapkan sebagai cerita teknis dari data proyek yang sudah ada." },
      { type: "paragraph", text: "Versi production nanti tersimpan sebagai block JSON dari editor CMS." },
    ],
  },
  {
    ...
    excerpt: "Draft refleksi tentang mengajar web development untuk sekitar 30 mahasiswa selama lima hari.",
    status: "local-preview",
    tags: ["Community", "Web"],
    publishedAt: "CMS pending",
    readTime: "5 min baca",
    ...
    blocks: [
      ...
      { type: "paragraph", text: "Komunitas menjadi bagian dari journey builder, bukan sekadar daftar aktivitas." },
      { type: "quote", text: "Blog CMS akan jadi tempat menulis proses, keputusan, dan pembelajaran." },
    ],
  },
];
