...
export const publicPageCopy = {
  home: {
    ...
    metadataDescription:
      "Mukhtada Billah NST is an Information Systems student at the University of Jambi who builds full-stack web products, AI tools, data projects, and research.",
    keywords: [
      "Mukhtada Billah NST",
  ...
  about: {
    ...
    metadataDescription:
      "Mukhtada Billah NST studies Information Systems at the University of Jambi and works on full-stack web development, AI tools, data science, and research.",
    keywords: [
      "Mukhtada Billah NST",
