import { profile, publicPageCopy } from "@/lib/data";
...
export const DEFAULT_TITLE = publicPageCopy.home.metadataTitle;
export const DEFAULT_DESCRIPTION = publicPageCopy.home.metadataDescription;
export const DEFAULT_KEYWORDS = publicPageCopy.home.keywords;
export const DEFAULT_SOCIAL_IMAGE = {
  url: "/opengraph-image",
  width: 1200,
  height: 630,
  alt: "Mukhtada Billah NST — Full-stack developer, AI tooling, and data research portfolio",
};
...
export function pageMetadata({
  ...
  return {
    ...
    openGraph: {
      type,
      locale: String(language || DEFAULT_LANGUAGE).replace("-", "_"),
      url: canonical,
      siteName: SITE_NAME,
      title: socialTitle,
      description,
