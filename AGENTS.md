...
| 2026-09-01 | Hero Ambient Life continuation scope and encounter cap | The supplied feature spec proposed several conditional environmental objects plus multiple simultaneous encounters, while the current Hero has no water or approved tower anchor and already carries a performance-sensitive renderer. | Implemented one scalar airborne group plus one decorative ground slot: an explicit 1/6 night firefly cluster, morning rabbit, and noon cat. Kept watchtower/smoke/lamp, water/boat, sky breathing, and audio deferred; compact fireflies use a navigation-safe horizontal dodge when the mobile vertical band is narrow. | User requests in this task; Sol Extra High architecture and final READY review; assertion-bearing evidence in `validation/hero-ambient-life-2026-09-01/`. |
| 2026-09-01 | Remove morning Hero rabbit | The owner explicitly requested the rabbit be removed after the Ambient Life continuation was delivered. | Deleted the rabbit SVG and morning render branch instead of hiding it. Ground fauna is now noon-cat-only; morning, sunset, and night render zero roots. Historical rabbit screenshots were removed from the current validation set but remain recoverable in Git history. | User request: “remove the rabbit then commit and push”; Sol Extra High final READY review; evidence in `validation/hero-ambient-life-2026-09-01/ground-fauna/`. |
